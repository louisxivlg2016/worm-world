...
export const GAME_EVENTS: GameEvent[] = [
  ...
  { id: 'hispanidad', label: 'Día de la Hispanidad', emoji: '🇪🇸', currencyImage: '/hispanidad-coin.png', lang: 'es',
    costumes: [{ id: 'hispanidad', label: 'Hidalgo España', preview: '/heads/hispanidad.png', bodyTexture: '/heads/hispanidad-body.png' }],
  ...
  { id: 'einheit', label: 'Tag der Einheit', emoji: '🇩🇪', currencyImage: '/einheit-coin.png', lang: 'de',
    costumes: [{ id: 'einheit', label: 'Patriot Deutschland', preview: '/heads/einheit.png', bodyTexture: '/heads/einheit-body.png' }],
  ...
  { id: 'repubblica', label: 'Festa della Repubblica', emoji: '🇮🇹', currencyImage: '/repubblica-coin.png', lang: 'it',
    costumes: [{ id: 'repubblica', label: 'Patriota Italia', preview: '/heads/repubblica.png', bodyTexture: '/heads/repubblica-body.png' }],
  ...
  { id: 'portugal', label: 'Dia de Portugal', emoji: '🇵🇹', currencyImage: '/portugal-coin.png', lang: 'pt',
    costumes: [{ id: 'portugal_nat', label: 'Patriota Portugal', preview: '/heads/portugal.png', bodyTexture: '/heads/portugal-body.png' }],
  ...
  { id: 'russia', label: 'День России', emoji: '🇷🇺', currencyImage: '/russia-coin.png', lang: 'ru',
    costumes: [{ id: 'russia_nat', label: 'Патриот России', preview: '/heads/russia.png', bodyTexture: '/heads/russia-body.png' }],
  ...
  { id: 'china', label: '国庆节', emoji: '🇨🇳', currencyImage: '/china-coin.png', lang: 'zh',
    costumes: [{ id: 'china_nat', label: '中华礼官', preview: '/heads/china.png', bodyTexture: '/heads/china-body.png' }],
  ...
  { id: 'india', label: 'Independence Day', emoji: '🇮🇳', currencyImage: '/india-coin.png', lang: 'hi',
    costumes: [{ id: 'india_nat', label: 'भारत रक्षक', preview: '/heads/india.png', bodyTexture: '/heads/india-body.png' }],
  ...
  { id: 'cumhuriyet', label: 'Cumhuriyet Bayramı', emoji: '🇹🇷', currencyImage: '/cumhuriyet-coin.png', lang: 'tr',
    costumes: [{ id: 'cumhuriyet', label: 'Cumhuriyet Beyi', preview: '/heads/cumhuriyet.png', bodyTexture: '/heads/cumhuriyet-body.png' }],
  ...
  { id: 'koningsdag', label: 'Koningsdag', emoji: '🇳🇱', currencyImage: '/koningsdag-coin.png', lang: 'nl',
    costumes: [{ id: 'koningsdag', label: 'Oranje Heer', preview: '/heads/koningsdag.png', bodyTexture: '/heads/koningsdag-body.png' }],
  ...
  { id: 'japan', label: '建国記念の日', emoji: '🇯🇵', currencyImage: '/japan-coin.png', lang: 'ja',
    costumes: [{ id: 'japan_nat', label: '和の使者', preview: '/heads/japan.png', bodyTexture: '/heads/japan-body.png' }],
  ...
  { id: 'korea', label: '광복절', emoji: '🇰🇷', currencyImage: '/korea-coin.png', lang: 'ko',
    costumes: [{ id: 'korea_nat', label: '광복 사절', preview: '/heads/korea.png', bodyTexture: '/heads/korea-body.png' }],
