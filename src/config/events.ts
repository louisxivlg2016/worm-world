...
export const GAME_EVENTS: GameEvent[] = [
  ...
  { id: 'hispanidad', label: 'Día de la Hispanidad', emoji: '🇪🇸', lang: 'es',
    costumes: [{ id: 'hispanidad', label: 'España', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'einheit', label: 'Tag der Einheit', emoji: '🇩🇪', lang: 'de',
    costumes: [{ id: 'einheit', label: 'Deutschland', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'repubblica', label: 'Festa della Repubblica', emoji: '🇮🇹', lang: 'it',
    costumes: [{ id: 'repubblica', label: 'Italia', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'portugal', label: 'Dia de Portugal', emoji: '🇵🇹', lang: 'pt',
    costumes: [{ id: 'portugal_nat', label: 'Portugal', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'russia', label: 'День России', emoji: '🇷🇺', lang: 'ru',
    costumes: [{ id: 'russia_nat', label: 'Россия', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'china', label: '国庆节', emoji: '🇨🇳', lang: 'zh',
    costumes: [{ id: 'china_nat', label: '中国', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'india', label: 'Independence Day', emoji: '🇮🇳', lang: 'hi',
    costumes: [{ id: 'india_nat', label: 'भारत', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'cumhuriyet', label: 'Cumhuriyet Bayramı', emoji: '🇹🇷', lang: 'tr',
    costumes: [{ id: 'cumhuriyet', label: 'Türkiye', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'koningsdag', label: 'Koningsdag', emoji: '🇳🇱', lang: 'nl',
    costumes: [{ id: 'koningsdag', label: 'Nederland', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'japan', label: '建国記念の日', emoji: '🇯🇵', lang: 'ja',
    costumes: [{ id: 'japan_nat', label: '日本', preview: '/heads/default.png', bodyTexture: '' }],
  ...
  { id: 'korea', label: '광복절', emoji: '🇰🇷', lang: 'ko',
    costumes: [{ id: 'korea_nat', label: '한국', preview: '/heads/default.png', bodyTexture: '' }],
