...
export const GAME_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    label: 'St Valentin',
    emoji: '💕',
    currencyImage: '/valentine-coin.png',
    costumes: [
      ...
      { id: 'valentine4', label: 'Cupidon Chic', preview: '/heads/valentine4.png', bodyTexture: '/heads/valentine4-body.png' },
    ],
  ...
  },
  {
    ...
    costumes: [
      ...
      { id: 'carnival3', label: 'Bouffon', preview: '/heads/carnival3.png', bodyTexture: '/heads/carnival3-body.png' },
  ...
  },
  {
    ...
    label: 'St Patrick',
    emoji: '☘️',
    currencyImage: '/stpatrick-coin.png',
    costumes: [
  ...
  },
  {
    ...
    costumes: [
      { id: 'ramadan', label: 'Croissant', preview: '/heads/ramadan-croissant-premium.png?v=2', bodyTexture: '/heads/eid-body.png' },
      { id: 'ramadan2', label: 'Fanous', preview: '/heads/ramadan-fanous-premium.png?v=2', bodyTexture: '/heads/eid2-body.png' },
      { id: 'ramadan3', label: 'Gardien de Lune', preview: '/heads/ramadan-guardian-premium.png?v=2', bodyTexture: '/heads/ramadan3-body.png' },
    ],
  ...
  },
  {
    ...
    costumes: [
      { id: 'eid', label: 'Croissant', preview: '/heads/ramadan-croissant-premium.png?v=2', bodyTexture: '/heads/eid-body.png' },
      { id: 'eid2', label: 'Fanous', preview: '/heads/ramadan-fanous-premium.png?v=2', bodyTexture: '/heads/eid2-body.png' },
      { id: 'eid3', label: 'Prince Croissant', preview: '/heads/ramadan-guardian-premium.png?v=2', bodyTexture: '/heads/eid3-body.png' },
    ],
  ...
  },
  {
    ...
    costumes: [
      ...
      { id: 'easter4', label: 'Dandy Pastel', preview: '/heads/easter4.png', bodyTexture: '/heads/easter4-body.png' },
    ],
  ...
  },
  {
    ...
    costumes: [
      { id: 'mayday', label: 'Ouvrière Fleurie', preview: '/heads/mayday-premium.svg?v=4', bodyTexture: '/heads/mayday-body.png' },
      { id: 'mayday2', label: 'Couronne du Printemps', preview: '/heads/mayday2-premium.svg?v=4', bodyTexture: '/heads/mayday2-body.png' },
      { id: 'mayday3', label: 'Héraut des Roses', preview: '/heads/mayday3-premium.svg?v=4', bodyTexture: '/heads/mayday3-body.png' },
    ],
  ...
  },
  {
    ...
    costumes: [
      { id: 'summer', label: 'Soleil Plage', preview: '/heads/summer-premium.svg?v=2', bodyTexture: '/heads/summer-body.png' },
      { id: 'summer2', label: 'Sorbet Chic', preview: '/heads/summer2-premium.svg?v=2', bodyTexture: '/heads/summer2-body.png' },
      { id: 'summer3', label: 'Lagune Tiki', preview: '/heads/summer3-premium.svg?v=2', bodyTexture: '/heads/summer3-body.png' },
  ...
  },
  {
    ...
    label: 'Halloween',
    emoji: '🎃',
    currencyImage: '/halloween-coin.png',
    costumes: [
      ...
      { id: 'halloween4', label: 'Seigneur Citrouille', preview: '/heads/halloween4.png', bodyTexture: '/heads/halloween4-body.png' },
    ],
  ...
  },
  {
    ...
    emoji: '💀',
    currencyImage: '/muertos-coin.png',
    costumes: [
      ...
      { id: 'muertos3', label: 'Catrina Majesté', preview: '/heads/muertos3.png', bodyTexture: '/heads/muertos3-body.png' },
    ],
  ...
  },
  {
    ...
    label: 'Thanksgiving',
    emoji: '🦃',
    currencyImage: '/thanksgiving-coin.png',
    costumes: [
      ...
      { id: 'thanksgiving3', label: 'Pèlerin d’Honneur', preview: '/heads/thanksgiving3.png', bodyTexture: '/heads/thanksgiving3-body.png' },
    ],
  ...
  },
  {
    ...
    label: 'Noël',
    emoji: '🎅',
    currencyImage: '/noel-coin.png',
    costumes: [
      { id: 'santa', label: 'Père Noël', preview: '/heads/santa.png', bodyTexture: '/heads/santa-body.svg' },
  ...
  },
  {
    ...
    label: 'Réveillon',
    emoji: '🥂',
    currencyImage: '/reveillon-coin.png',
    costumes: [
      ...
      { id: 'reveillon5', label: 'Reine Champagne', preview: '/heads/reveillon5.svg', bodyTexture: '/heads/reveillon-body.png' },
      { id: 'reveillon6', label: 'Muse de Minuit', preview: '/heads/reveillon6.svg', bodyTexture: '/heads/reveillon2-body.png' },
      { id: 'reveillon7', label: 'Diva Disco', preview: '/heads/reveillon7.svg', bodyTexture: '/heads/reveillon3-body.png' },
    ],
  ...
  { id: 'hispanidad', label: 'Día de la Hispanidad', emoji: '🇪🇸', currencyImage: '/hispanidad-coin.png', lang: 'es',
    costumes: [
      { id: 'hispanidad', label: 'Hidalgo España', preview: '/heads/hispanidad.png', bodyTexture: '/heads/hispanidad-body.png' },
      { id: 'hispanidad_flag', label: 'Bandera de España', preview: '/drapeau/espagne.png', bodyTexture: '/drapeau/espagne.png' },
    ],
  ...
  { id: 'einheit', label: 'Tag der Einheit', emoji: '🇩🇪', currencyImage: '/einheit-coin.png', lang: 'de',
    costumes: [
      { id: 'einheit', label: 'Patriot Deutschland', preview: '/heads/einheit.png', bodyTexture: '/heads/einheit-body.png' },
      { id: 'einheit_flag', label: 'Deutschland Flagge', preview: '/drapeau/allemagne.png', bodyTexture: '/drapeau/allemagne.png' },
    ],
  ...
  { id: 'repubblica', label: 'Festa della Repubblica', emoji: '🇮🇹', currencyImage: '/repubblica-coin.png', lang: 'it',
    costumes: [
      { id: 'repubblica', label: 'Patriota Italia', preview: '/heads/repubblica.png', bodyTexture: '/heads/repubblica-body.png' },
      { id: 'repubblica_flag', label: 'Bandiera d’Italia', preview: '/drapeau/italie.png', bodyTexture: '/drapeau/italie.png' },
    ],
  ...
  { id: 'portugal', label: 'Dia de Portugal', emoji: '🇵🇹', currencyImage: '/portugal-coin.png', lang: 'pt',
    costumes: [
      { id: 'portugal_nat', label: 'Patriota Portugal', preview: '/heads/portugal.png', bodyTexture: '/heads/portugal-body.png' },
      { id: 'portugal_flag', label: 'Bandeira de Portugal', preview: '/drapeau/portugal.png', bodyTexture: '/drapeau/portugal.png' },
    ],
  ...
  { id: 'russia', label: 'День России', emoji: '🇷🇺', currencyImage: '/russia-coin.png', lang: 'ru',
    costumes: [
      { id: 'russia_nat', label: 'Патриот России', preview: '/heads/russia.png', bodyTexture: '/heads/russia-body.png' },
      { id: 'russia_flag', label: 'Флаг России', preview: '/drapeau/russie.png', bodyTexture: '/drapeau/russie.png' },
    ],
  ...
  { id: 'china', label: '国庆节', emoji: '🇨🇳', currencyImage: '/china-coin.png', lang: 'zh',
    costumes: [
      { id: 'china_nat', label: '中华礼官', preview: '/heads/china.png', bodyTexture: '/heads/china-body.png' },
      { id: 'china_flag', label: '中国国旗', preview: '/drapeau/chine.png', bodyTexture: '/drapeau/chine.png' },
    ],
  ...
  { id: 'india', label: 'Independence Day', emoji: '🇮🇳', currencyImage: '/india-coin.png', lang: 'hi',
    costumes: [
      { id: 'india_nat', label: 'भारत रक्षक', preview: '/heads/india.png', bodyTexture: '/heads/india-body.png' },
      { id: 'india_flag', label: 'भारत ध्वज', preview: '/drapeau/inde.png', bodyTexture: '/drapeau/inde.png' },
    ],
  ...
  { id: 'cumhuriyet', label: 'Cumhuriyet Bayramı', emoji: '🇹🇷', currencyImage: '/cumhuriyet-coin.png', lang: 'tr',
    costumes: [
      { id: 'cumhuriyet', label: 'Cumhuriyet Beyi', preview: '/heads/cumhuriyet.png', bodyTexture: '/heads/cumhuriyet-body.png' },
      { id: 'cumhuriyet_flag', label: 'Türk Bayrağı', preview: '/drapeau/turquie.png', bodyTexture: '/drapeau/turquie.png' },
    ],
  ...
  { id: 'koningsdag', label: 'Koningsdag', emoji: '🇳🇱', currencyImage: '/koningsdag-coin.png', lang: 'nl',
    costumes: [
      { id: 'koningsdag', label: 'Oranje Heer', preview: '/heads/koningsdag.png', bodyTexture: '/heads/koningsdag-body.png' },
      { id: 'koningsdag_flag', label: 'Nederlandse Vlag', preview: '/drapeau/pays-bas.png', bodyTexture: '/drapeau/pays-bas.png' },
    ],
  ...
  { id: 'japan', label: '建国記念の日', emoji: '🇯🇵', currencyImage: '/japan-coin.png', lang: 'ja',
    costumes: [
      { id: 'japan_nat', label: '和の使者', preview: '/heads/japan.png', bodyTexture: '/heads/japan-body.png' },
      { id: 'japan_flag', label: '日本の国旗', preview: '/drapeau/japon.png', bodyTexture: '/drapeau/japon.png' },
    ],
  ...
  { id: 'korea', label: '광복절', emoji: '🇰🇷', currencyImage: '/korea-coin.png', lang: 'ko',
    costumes: [
      { id: 'korea_nat', label: '광복 사절', preview: '/heads/korea.png', bodyTexture: '/heads/korea-body.png' },
      { id: 'korea_flag', label: '태극기', preview: '/drapeau/coree-du-sud.png', bodyTexture: '/drapeau/coree-du-sud.png' },
    ],
